...
5. **2.1 Igualdad:** Arma una consulta para obtener todos los datos de los estudiantes cuyo `apellido` sea exactamente 'Lopez'.
...
10. **2.5 OR:** Arma una consulta para obtener los estudiantes cuyo `apellido` sea 'Lopez' **o** 'Garcia'.
